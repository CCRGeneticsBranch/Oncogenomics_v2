    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                {!!Form::model($permission, [ 'url' => [URL::action('\LaravelAcl\Authentication\Controllers\PermissionController@editPermission'), $permission->id], 'method' => 'post'] ) !!}
                ...
                {!!Form::hidden('id')!!}
                <a href="{!!URL::action('\LaravelAcl\Authentication\Controllers\PermissionController@deletePermission',['id' => $permission->id, '_token' => csrf_token()])!!}" class="btn btn-danger pull-right margin-left-5 delete">Delete</a>
