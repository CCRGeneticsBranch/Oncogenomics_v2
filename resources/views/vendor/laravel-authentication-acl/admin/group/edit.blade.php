            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        {{-- group base form --}}
                        <h4>General data</h4>
                        {!!Form::model($group, [ 'url' => [URL::action('\LaravelAcl\Authentication\Controllers\GroupController@postEditGroup'), $group->id], 'method' => 'post'] ) !!}
                        <!-- name text field -->
                        ...
                        {!!Form::hidden('id')!!}
                        <!--a href="{!!URL::action('\LaravelAcl\Authentication\Controllers\GroupController@deleteGroup',['id' => $group->id, '_token' => csrf_token()])!!}" class="btn btn-danger pull-right margin-left-5 delete">Delete</a-->
